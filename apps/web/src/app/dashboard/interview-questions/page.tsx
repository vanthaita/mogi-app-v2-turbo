...
import { FaBriefcase, FaUserTie, FaLanguage, FaQuestionCircle } from 'react-icons/fa';
...
const InterviewCard: React.FC<{ interview: InterViewData }> = ({ interview }) => {
    ...
    return (
        ...
        <Link href={`/dashboard/interview/${interview.id}/`} className="flex items-center space-x-4">
            ...
            <img src={interview.companyLogoUrl || ""} alt="Company logo" className="w-full h-full object-cover" />
            </div>
        ...
        <CardContent className="space-y-3 mt-4">
            ...
            <span className='truncate break-words'>{interview.companyInfo || 'Mogi'}</span>
            </p>
            <p className="flex items-center text-sm text-gray-700">
